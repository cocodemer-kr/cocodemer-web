...
COPY = {
    'ko': {
        ...
        'h1': 'INGREDIENTS',
        'sub': '액티브 원료 45종',
        'lead': '맞춤 조제에 사용했던 액티브 원료의 기록입니다. '
                'Skin Code의 피부 타입별 처방과 당시 완제품에도 '
                '같은 원료 체계를 활용했습니다. '
        ...
        'lc_lead': '세이셸에서만 자라는 코코 드 메르 씨앗에서 시작한 독자 원료입니다. '
                   '맞춤형 화장품 시기에 개발했습니다.',
        ...
        'lc_p4': '<b>아미노산 구성</b> — 코코 드 메르 씨앗의 구성을 식물 원료로 재현했습니다.',
        'lc_note': '※ 맞춤형 화장품을 운영하던 시기에 사용했던 원료입니다. '
                   '현재 판매 중인 Aqua Quick Bubble Mask에는 '
                   'L-CODEMAR ELIXIR™이 적용되지 않습니다.',
    },
    'en': {
